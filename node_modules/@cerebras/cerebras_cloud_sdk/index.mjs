...
export class Cerebras extends Core.APIClient {
     ...
     */
    constructor({ baseURL = Core.readEnv('CEREBRAS_BASE_URL'), apiKey = Core.readEnv('CEREBRAS_API_KEY'), ...opts } = {}) {
        if (apiKey === undefined) {
...
export const { CerebrasError, APIError, APIConnectionError, APIConnectionTimeoutError, APIUserAbortError, NotFoundError, ConflictError, RateLimitError, BadRequestError, AuthenticationError, InternalServerError, PermissionDeniedError, UnprocessableEntityError, } = Errors;
export var toFile = Uploads.toFile;
export var fileFromPath = Uploads.fileFromPath;
(function (Cerebras) {
    Cerebras.Chat = API.Chat;
    Cerebras.Models = API.Models;
})(Cerebras || (Cerebras = {}));
